tcb->m_segmentSize = (int) (tcb->m_segmentSize-(tcb->m_segmentSize)-(-5.04)-(-10.42));
tcb->m_segmentSize = (int) (15.79)/(tcb->m_segmentSize);
tcb->m_segmentSize = (int) (12.21+(-3.25)+(-3.86)+(2.25));
